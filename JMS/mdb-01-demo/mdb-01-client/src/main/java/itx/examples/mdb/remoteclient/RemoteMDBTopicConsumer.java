...
public class RemoteMDBTopicConsumer {
	
	private static final Logger logger = Logger.getLogger(RemoteMDBTopicConsumer.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			try (JMSContext context = connectionFactory.createContext(DEFAULT_USERNAME,	DEFAULT_PASSWORD)) {
				...
				context.start();
				logger.info("Waiting for incomming Topic message ...");
