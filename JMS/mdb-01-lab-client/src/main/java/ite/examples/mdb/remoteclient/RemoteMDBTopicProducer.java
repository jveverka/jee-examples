...
public class RemoteMDBTopicProducer {
	
	private static final Logger logger = Logger.getLogger(RemoteMDBTopicProducer.class.getName());
	
	private static final String DEFAULT_MESSAGE = "Hello from remote MDB Topic client.";
	private static final String DEFAULT_CONNECTION_FACTORY = "jms/RemoteConnectionFactory";
	private static final String DEFAULT_DESTINATION = "jms/topic/TestTopic";
