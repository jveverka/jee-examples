...
public class AuthFilter implements ContainerRequestFilter {
	...
	private static final String LOGIN_URI_ROOT = "/ws/authrest";
	...
	public void filter(ContainerRequestContext requestContext) throws IOException {
		...
		UserInfo userInfo = authService.getRoles(sessionId);
		if (userInfo != null) { 
			logger.info("setting security context for: " + userInfo.getUserName());
