...
public class DeviceListResponseJsonProvider extends AbstractProtocolJsonProvider<DeviceListResponse> {
	
	private static final Logger logger = Logger.getLogger(DeviceListResponseJsonProvider.class.getName());
	...
	public DeviceListResponse readFrom(Class<DeviceListResponse> type, Type genericType, Annotation[] annotations,
		...
		DeviceListResponse.Builder builder = DeviceListResponse.newBuilder();
