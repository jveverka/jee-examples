...
public class KillHttpSessionRequestJsonProvider extends AbstractProtocolJsonProvider<KillHttpSessionRequest> {

	@Override
	public KillHttpSessionRequest readFrom(Class<KillHttpSessionRequest> type, Type genericType, Annotation[] annotations,
			MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream)
			throws IOException, WebApplicationException {
		String jsonMessage = CharStreams.toString(new InputStreamReader(entityStream, Charsets.UTF_8));
		KillHttpSessionRequest.Builder builder = KillHttpSessionRequest.newBuilder();
