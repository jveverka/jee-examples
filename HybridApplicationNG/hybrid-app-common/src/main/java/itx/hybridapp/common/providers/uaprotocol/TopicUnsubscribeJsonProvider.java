...
public class TopicUnsubscribeJsonProvider extends AbstractProtocolJsonProvider<TopicUnsubscribe> {
	
	private static final Logger logger = Logger.getLogger(TopicUnsubscribeJsonProvider.class.getName());
	...
	public TopicUnsubscribe readFrom(Class<TopicUnsubscribe> type, Type genericType, Annotation[] annotations,
		...
		TopicUnsubscribe.Builder builder = TopicUnsubscribe.newBuilder();
