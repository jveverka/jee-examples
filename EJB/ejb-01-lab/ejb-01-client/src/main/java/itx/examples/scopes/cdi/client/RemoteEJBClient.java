package itx.examples.scopes.cdi.client;
...
import itx.examples.scopes.cdi.StatefulRemote;
import itx.examples.scopes.cdi.StatelessRemote;
...
public class RemoteEJBClient {
	...
	private static StatefulRemote lookupStatefulRemoteEJB() throws NamingException {
		...
		StatefulRemote bean = (StatefulRemote)context.lookup("ejb:/ejb-01-server/StatefulBean!itx.examples.scopes.cdi.StatefulRemote?stateful");
		return bean;
	}
	...
	private static StatelessRemote lookupStatelessRemoteEJB() throws NamingException {
		...
		jndiProperties.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming");
		final Context context = new InitialContext(jndiProperties);
		StatelessRemote bean = (StatelessRemote)context.lookup("ejb:/ejb-01-server/StatelessBean!itx.examples.scopes.cdi.StatelessRemote");
		return bean;
	}
